...
kubectl rollout status deployment/node-api --timeout=60s
	...
	Use the triage loop. Answer these:
		1. What did rollout status report, and what does that tell you? 2What state are the Pods in? How many of each?
		2. Which layer, from the Sub-lab 3.4 table, has failed?
		3. What do the endpoints show?
		4. How many requests failed?
4.2 — The diagnosis
bash
kubectl get pods -l app=node-api -o wide
kps
