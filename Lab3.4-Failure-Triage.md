...
for n in lab3-control-plane lab3-worker lab3-worker2; do
  echo "== Pulling netshoot on $n =="
  docker exec "$n" crictl pull docker.io/nicolaka/netshoot:latest
done
...
Check whether you have added it. This was changed in the code:
...
```
Warning  FailedScheduling  default-scheduler  0/3 nodes are available: 1 node(s) had untolerated taint
